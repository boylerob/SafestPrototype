...
exports.sosCall = async (req, res) => {
  ...
  try {
    ...
    const webhookUrl = 'https://us-central1-safest-prototype-461018.cloudfunctions.net/webhook';
    // const twiml = new twilio.twiml.VoiceResponse();
    // twiml.say({ voice: 'alice', language: 'en-US' }, 'Hey, are you okay? How can I help?');
    // twiml.gather({
    //   input: 'speech',
    //   action: `${webhookUrl}?conversationId=${conversationId}`,
    //   method: 'POST',
    //   speechTimeout: 'auto',
    //   language: 'en-US'
    // });
